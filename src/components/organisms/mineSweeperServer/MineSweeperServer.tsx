...
import { useBoardServer } from '../../../utils/useBoardServer';

export default function MineSweeperServer() {
    const { loading, board, coins, gameOver, message, revealCell, cashOut, restart } =
        useBoardServer();
    ...
    return (
        <>
            ...
            <div className={styles.container}>
                <Title coins={coins} text="MineSweeper Crash (server)" />
